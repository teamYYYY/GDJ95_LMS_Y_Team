package com.example.lms.controller.profCourseNotice;
...
import com.example.lms.service.profCourseNotice.CourseNoticeService;
...
public class CourseNoticeController {
	...
	public String addcourseNotice(CourseNoticeDTO courseNotice, HttpSession session) {
		...
		if(!"PROFESSOR".equals(loginUser.getUserAuth())) { 
			return "redirect:/login";
		}
